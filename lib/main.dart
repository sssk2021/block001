...
// Includes  caller info, but this is expensive.
    ...
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        TopView.pageName: (BuildContext context) => TopView(),
        ComCheckView.pageName: (BuildContext context) => ComCheckView(),
        GameApp.pageName: (BuildContext context) => GameApp(mode: 'normal',),
        GameApp.pageName2: (BuildContext context) => GameApp(mode: 'time',),
      },
    );
  }
}
